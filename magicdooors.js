...
openDoor(true, 105); // Виведе: Двері магічно відчиняються! Відповідь на все! Двері розкриваються широко.
openDoor(false, 99); // Виведе: Двері залишаються закритими міцно. Хм... Нічого не відбувається з цим кодом.
openDoor(true, 42); // Виведе: Двері магічно відчиняються! Відповідь на все! Двері розкриваються широко.
